...
function RegisterRoutes(app) {
    app.get('/api/v1/actuator/get', authenticateMiddleware([{ "api_key": [] }]), function ActuatorReadMethods_getActuators(request, response, next) {
        const args = {
    ...
    app.get('/api/v1/actuator/:typeOrName/get', authenticateMiddleware([{ "api_key": [] }]), function ActuatorReadMethods_getCategorizedActuators(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
    ...
    app.get('/api/v1/sensor/:typeOrName/get', authenticateMiddleware([{ "api_key": [] }]), function SensorReadMethods_getCategorizedSensors(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
            typeOrName: { "in": "path", "name": "typeOrName", "required": true, "dataType": "string" },
        };
    ...
    app.get('/api/v1/log/sensor/get', authenticateMiddleware([{ "api_key": [] }]), function SystemLogsReadMethods_getSensorLogs(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
        };
        let validatedArgs = [];
    ...
    app.get('/api/v1/log/actuator/get', authenticateMiddleware([{ "api_key": [] }]), function SystemLogsReadMethods_getActuatorLogs(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
        };
        let validatedArgs = [];
    ...
    app.patch('/api/v1/actuator/update', authenticateMiddleware([{ "api_key": [] }]), function ActuatorWriteMethods_updateActuator(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
    ...
    app.post('/api/v1/sensor/add', authenticateMiddleware([{ "api_key": [] }]), function SensorWriteMethods_addSensor(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
    ...
    app.patch('/api/v1/sensor/update', authenticateMiddleware([{ "api_key": [] }]), function SensorWriteMethods_updateSensor(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
    ...
    app.post('/api/v1/sensor/:sensorName/data/add', authenticateMiddleware([{ "api_key": [] }]), function SensorWriteMethods_addSensorData(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
    ...
    app.post('/api/v1/systemCommand/startSystem', authenticateMiddleware([{ "api_key": [] }]), function SystemCommandWriteMethods_startSystem(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
        };
        let validatedArgs = [];
    ...
    app.post('/api/v1/systemCommand/pauseSystem', authenticateMiddleware([{ "api_key": [] }]), function SystemCommandWriteMethods_pauseSystem(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
        };
        let validatedArgs = [];
    ...
    app.post('/api/v1/systemCommand/stopSystem', authenticateMiddleware([{ "api_key": [] }]), function SystemCommandWriteMethods_stopSystem(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
        };
        let validatedArgs = [];
    ...
    app.post('/api/v1/systemCommand/restartSystem', authenticateMiddleware([{ "api_key": [] }]), function SystemCommandWriteMethods_restartSystem(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
        };
        let validatedArgs = [];
    ...
    app.post('/api/v1/log/sensor/add', function SystemLogsWriteMethods_addSensorLog(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
    ...
    app.post('/api/v1/log/actuator/add', function SystemLogsWriteMethods_addActuatorLog(request, response, next) {
        const args = {
            accessToken: { "in": "query", "name": "accessToken", "required": true, "dataType": "string" },
            logContent: { "in": "body-prop", "name": "logContent", "required": true, "dataType": "string" },
        };
    ...
    app.post('/api/v1/register', function SecurityMethods_register(request, response, next) {
        const args = {
    ...
    app.post('/api/v1/login', function SecurityMethods_login(request, response, next) {
        const args = {
            email: { "in": "body-prop", "name": "email", "required": true, "dataType": "string" },
            password: { "in": "body-prop", "name": "password", "required": true, "dataType": "string" },
        };
    ...
    app.post('/api/v1/login/refresh', function SecurityMethods_refreshLoginCredentials(request, response, next) {
        const args = {
            email: { "in": "body-prop", "name": "email", "required": true, "dataType": "string" },
            password: { "in": "body-prop", "name": "password", "required": true, "dataType": "string" },
        };
