...
const pushLog = (path, log, publisher) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield (0, shorthandOps_1.createWriteEvent)({
        ...
        protectedMethods: {
            ...
            read() {
                return __awaiter(this, void 0, void 0, function* () {
                    yield realtime.getContent(`${path}/logCount`, (ref) => __awaiter(this, void 0, void 0, function* () {
...
class SystemLogsService {
    ...
    getSensorLogs(oldestTimestamp = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield getLog(oldestTimestamp, "logs/sensor");
    ...
    getActuatorLogs(oldestTimestamp = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield getLog(oldestTimestamp, "logs/actuator");
            constants_1.logger.debug(`All logs: ${result}`);
            return result.length ? (0, option_1.Some)(result.map(json => systemLogDto_1.LogDTO.fromJson(json))) : option_1.None;
        });
    }
    addSensorLog(log) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield pushLog("logs/sensor", log, this.publisher);
        });
    }
    addActuatorLog(log) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield pushLog("logs/actuator", log, this.publisher);
        });
    }
}
